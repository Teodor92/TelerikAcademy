...
{
	public partial class NortwindEntity : OpenAccessContext, INortwindEntityUnitOfWork
	{
		private static string connectionStringName = @"NorthwindConnection";
			
		private static BackendConfiguration backend = GetBackendConfiguration();
				
		private static MetadataSource metadataSource = new NortwindEntityMetadataSource();
		
		public NortwindEntity()
			:base(connectionStringName, backend, metadataSource)
		{ }
		
		public NortwindEntity(string connection)
			:base(connection, backend, metadataSource)
		{ }
		
		public NortwindEntity(BackendConfiguration backendConfiguration)
			:base(connectionStringName, backendConfiguration, metadataSource)
		{ }
			
		public NortwindEntity(string connection, MetadataSource metadataSource)
			:base(connection, backend, metadataSource)
		{ }
		
		public NortwindEntity(string connection, BackendConfiguration backendConfiguration, MetadataSource metadataSource)
	...
	public interface INortwindEntityUnitOfWork : IUnitOfWork
	{
