...
namespace JustWeather
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            SettingsCommand command = new SettingsCommand("customizations", "Customizations", (handler) =>
            {
                Popup popup = BuildSettingsItem(new AppCustomSettings(), 300);
                popup.IsOpen = true;
            });
